...
public class RestClient {
	...
	private static final String REGISTRATION_REST_URL = "http://0.0.0.0:9090/route/blackjack/register/";
	...
	public String register(String playerName) {
		...
		String string = client.resource("http://0.0.0.0:9090/route/blackjack/register/echo/hello").get(String.class);
